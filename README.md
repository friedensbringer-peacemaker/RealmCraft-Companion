...
The **[Companion Web Demo](RealmCraftWebDemo/README.md)** is a separate, dependency-free web project in this repository. Use the GitHub Pages link in the repository's About section to try its map, chest search, inventory sandbox, 46 build guides, ten reference recipes and context export. The reviewed demonstration ZIP loads automatically on startup; you can also open a local savegame ZIP entirely in your browser. Local files are never uploaded or patched.

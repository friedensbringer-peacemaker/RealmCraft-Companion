...
files.extend(base/name for name in ['Tools/build_public_wiki.py', 'Tools/AuditLauncher.swift', 'Tools/prepare_ui_audit.py', 'Tools/audit_helper_diagnostics.py', 'Tools/video_workspace.py', 'Tools/build_crafting_catalog.py', 'Tools/add_coach_modules.py', 'Documentation/BUILD_COACH_INSPIRATION.md', 'docs/UI-UX-AUDIT-2026-09-12.md', 'docs/METRO-WORKSPACE-2026-09-09.md'])

...
struct SetupView: View {
    ...
    @ViewBuilder private var page: some View {
        ...
        default:
            ...
            instruction("tray.and.arrow.down", t("Next: open Worlds & backups, choose the correct headset and world, then Back up Quest → Mac. Wait for successful verification. If there are several worlds, choose deliberately and back them up separately. No backup starts when you finish this guide.", "Als Nächstes: Öffne Welten & Sicherungen, wähle die richtige Brille und Welt und dann Backup Quest → Mac. Warte auf die erfolgreiche Prüfung. Gibt es mehrere Welten, wähle bewusst und sichere sie separat. Beim Abschließen dieser Anleitung startet kein Backup."))
            ...
            VStack(alignment: .leading, spacing: 18) {
                ...
                GroupBox {
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        } else { Text(t("Select a backup under Worlds & backups to export it as ZIP.", "Wähle unter Welten & Sicherungen ein Backup, um es als ZIP zu exportieren.")).font(.caption) }
